// ═══════════════════════════════════════════════════════════════
//  MedScan — Google Apps Script (Fixed)
//  Uses Sheet ID directly — no binding issues
// ═══════════════════════════════════════════════════════════════

// ⚠ PASTE YOUR SHEET ID HERE ⚠
const SPREADSHEET_ID = "1FgAbnK9wcDG1zRDYMjA5-Db_wZaQilNEaXaZh4wQNyM";
...
// ── Get or create the MedScan sheet ────────────────────────────
